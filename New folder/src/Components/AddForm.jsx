...
function AddForm() {
    ...
    const submitEdit = (e) => {
        ...
        //     if (personalInfo[i].id === count) {
        //         personalInfo[i].data = editInfo
        //     }
        // }
        const updateEdit = personalInfo.map((item) => {
            if(personalInfo.id === count){
                return {
                    ...item, 
                    data : editInfo
                }
        ...
        //     },
        // ]
        console.log("obj",updateEdit);
        // localStorage.setItem("personalInfo", JSON.stringify(editInfo))
    }
